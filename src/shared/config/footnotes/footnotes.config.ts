...
export const footnotesConfig: Record<string, { source: string; url?: string }> =
	{
		...
		zweig_world_of_yesterday_2009: {
			source:
				'Stefan Zweig. The World of Yesterday: Memoirs of a European. Translated from the German by Anthea Bell. Pushkin Press Classics, London, 2009, 474 p.',
			url: ''
		},
