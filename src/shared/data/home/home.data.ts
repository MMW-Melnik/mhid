		...
		'Growing up in the Belle Epoque': {
			CHAPTER1: {
				...
				CHARLOTTE: {
					...
					PARAGRAPH_9: [
						'According to her biographers, Princess Mary Adelaide was not ready for the role of Grand Duchess. First of all, because she was too young and inexperienced when she lost her father and inherited the throne. At the same time, Charlotte, being close to her sister, gained valuable experience that helped her in the future. '
					]
				},
				SOFIA: {
					PARAGRAPH_1: [
		...
		'INTERWAR PERIOD': {
			CHAPTER3: {
				...
				SOFIA: {
					...
					PARAGRAPH_8: [
						"'she would not keep the property for herself, but would give it to those in her family who would need it when they needed it.'"
					],
					PARAGRAPH_9: [
		...
		'AFTER WAR': {
			CHAPTER5: {
				...
				CHARLOTTE: {
					...
					PARAGRAPH_3: [
						"The program intertwines Luxembourgers' memories of the Grand Duchess as a monarch at the head of state with her grandchildren's memories of their own grandmother.",
